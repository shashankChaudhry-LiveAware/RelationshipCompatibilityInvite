...
<head>
  ...
  <title>Compatibility Check | LiveAware</title>
...
<body>
  ...
  <div id="successScreen" class="screen hidden">
    <div class="screen-card">
      ...
      <p>Your Personality Type assessment has been submitted. Your partner can view the Compatibility Check Fit report in Live Aware.</p>
  ...
  <div id="mainForm" class="container hidden">
    ...
    <div class="invite-info">
      <p><strong id="inviterName">Someone</strong> invited you to a Compatibility Check — complete your Personality Type so you both can see Fit (not a shared relationship workspace).</p>
